                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <?php if ($_SESSION['user'] ?? false) : ?>
                            <a href="/articles"
                               class="<?= urlIs('/articles') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">My Articles</a>
                        <?php endif ?>
                        <a href="/categories"
                           class="<?= urlIs('/categories') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Categories</a>
<!--                        <a href="/about"-->
