    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="flex justify-between items-center mb-4">
            <div class="mx-auto max-w-2xl lg:mx-0">
                <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">My Articles</h2>
                <p class="mt-2 text-lg leading-8 text-gray-600">Browse your existing articles or create new ones with ease.</p>
            </div>
            <a href="/articles/create" class="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                Create article
            </a>
        </div>
